...
## Marching Squares!
Alright, now we're all prepped up and ready to implement Marching Squares. Here's the link to a [p5.js sketch](https://editor.p5js.org/skadewdle/sketches/c9x7BbAG1) for the same. Oh, and you might have already seen this - but here's the output of the sketch (yes it's the same animation as above but I'm really proud of it so here it is again).
