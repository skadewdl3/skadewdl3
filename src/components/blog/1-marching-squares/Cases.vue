...
function drawIsolines(i, j, cellSize) {
  ...
  switch (state) {
    case 1: // Bottom left corner
      p.line(x, y + cellSize / 2, x + cellSize / 2, y + cellSize)
      break
    case 2: // Bottom right corner
      p.line(x + cellSize / 2, y + cellSize, x + cellSize, y + cellSize / 2)
      break
    case 3: // Bottom edge
      p.line(x, y + cellSize / 2, x + cellSize, y + cellSize / 2)
      break
    case 4: // Top right corner
      p.line(x + cellSize / 2, y, x + cellSize, y + cellSize / 2)
      break
    case 5: // Diagonal case
      p.line(x, y + cellSize / 2, x + cellSize / 2, y)
      p.line(x + cellSize / 2, y + cellSize, x + cellSize, y + cellSize / 2)
      break
    case 6: // Right edge
